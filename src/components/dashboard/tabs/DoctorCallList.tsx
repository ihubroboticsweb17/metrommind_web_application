...
//         extension:doctorList.voxbay_details.ext_no,
//         destination:localStorage.getItem("userFullPhone"),
//       });
      
//       if (callResponse.status === "success") {
//         toast({
//           title: "Call Initiated",
//           description: `The call has been initiated, we will contact you shortly`,
//         });
//       }
...
const DoctorCallList = () => {
  ...
  const handleCallDoctor = async (doctor: Doctor) => {
    try {
      ...
      //   return;
      // }
       const userPhoneRaw = localStorage.getItem("userFullPhone");
      if (!userPhoneRaw) {
        toast({
          title: "Call Failed",
          description: "Your phone number not found. Please update your profile.",
