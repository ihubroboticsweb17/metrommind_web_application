...
const PatientAppointments = ({ theme = "green" }: PatientAppointmentsProps) => {
            ...
            <div className="space-y-4">
              <div className="flex flex-col items-center justify-center pb-4 border-b border-gray-200">
                ...
                <h3 className="font-semibold text-lg text-gray-800">
                  Dr. {selectedAppointment.doctor_details.name}
                </h3>
                <p className="text-gray-600 capitalize">
                  {selectedAppointment.doctor_details.role}
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{selectedAppointment.doctor_details.mobile_number}</p>
                  </div>
                </div>
