...
// import { CheckCircle, Download, EyeIcon, X } from "lucide-react";
// import {
//   Dialog,
//   DialogContent,
//   DialogHeader,
...
//     fetchPatients();
//   }, [toast, loading]);
//   const getPatientState = (patientId) => {
//   return patientStates[patientId] || {
...
// // useEffect(() => {
// //   if (selectedPatient) {
// //     setIsAddNotSuccss(false);
// //     setIsApproved(false);
// //     setAddOnObs("");
// //     // Reset other relevant states for the new patient
// //   }
// // }, [selectedPatient?.id]);
// useEffect(() => {
//   if (selectedPatient) {
//     // Reset states specific to the selected patient
//     setIsAddNotSuccss(false);
//     setIsApproved(false);
//     setIsApprovedSecond(false);
//     setIsSecondAssessmentSubmitted(false);
//     setAddOnObs("");
//     setAddOnSecondObs("");
//     setTherapistNotes("");
//     setPdfUrl(null);
//     setSecondAssessmentPdfUrl("");

//     // Check if patient already has diagnosis and notes
//     if (selectedPatient?.diagnosis?.length > 0) {
//       const lastDiagnosis = selectedPatient.diagnosis[selectedPatient.diagnosis.length - 1];

//       // Check if therapist notes already exist for this patient
//       // You may need to add a field in your API to track this
//       // For now, we'll assume if there's a diagnosis, we need to check its status

//       // Set PDF URL if already generated
...
// }, [selectedPatient?.id]);
//   // useEffect(() => {
//   //   if (selectedPatient?.diagnosis?.length > 0 && selectedPatient.diagnosis[0].ai_report?.therapist_report) {

//   //     setCheckState(selectedPatient.diagnosis[0].ai_report.therapist_report);
//   //     setDisease(selectedPatient.diagnosis[length-1].id)
//   //     console.log("data to check id",disease)
//   //   }
//   // }, [selectedPatient]);
//   useEffect(() => {
//     if (
...
//       // console.log("lastDiagnosisKKKKK", lastDiagnosis.ai_report.patient_report.patient_summary);
...
//   // const handleSubmitTherapistNotes = () => {
//   //   // Here you would typically save the therapist notes to your backend
//   //   toast({
//   //     title: "Success",
...
//     }
//   };
//   const handleApproveAiDiagnosisSummary = async (disease: number) => {
//     if (!disease) return;
...
//         setAddOnSecondObs(addOnSecondObs);
//         setIsApproved(true);
...
//                                     >
//                                        {isAddNotSuccss ? "Notes Submitted ✓" : "Add Therapist Notes"}
//                                       {/* Add Therapist Notes */}
//                                     </Button>
...
//                                       {/* Approve Daignosis */}
//                                       {isApproved ? "Diagnosis Approved ✓" : "Approve Diagnosis"}
//                                     </Button>
//                                   </div>
...
//                                     <Button onClick={() => setOpenSecondDialog(true)}>
