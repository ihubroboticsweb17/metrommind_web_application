...
const Chatbox = forwardRef<ChatboxRef, ChatboxProps>((props, ref) => {
  ...
  return (
    <div className="flex flex-col w-full h-screen relative">
      {/* Messages Area */}
      <div className="flex-1 overflow-y-auto px-2 md:px-16 py-4 w-full mb-[80px]">
        <div className="mx-auto w-full max-w-5xl space-y-6">
          {messages.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-sm text-muted-foreground">
                I'm here to help you. Ask me anything about your mental health
                and wellbeing.
              </p>
            </div>
          )}
          ...
          {isLoading && (
            <div className="flex items-start space-x-3">
              ...
              <div className="bg-muted/50 border border-border/50 rounded-2xl rounded-bl-sm p-3">
                <div className="flex space-x-1">
                  <div className="w-2 h-2 bg-muted-foreground/40 rounded-full animate-pulse delay-0"></div>
                  <div className="w-2 h-2 bg-muted-foreground/40 rounded-full animate-pulse delay-200"></div>
                  <div className="w-2 h-2 bg-muted-foreground/40 rounded-full animate-pulse delay-400"></div>
                </div>
              </div>
            </div>
          )}
      ...
      {/* Input Area - Fixed at bottom (simplified without Generate Report button) */}
      <div className="fixed bottom-0 left-0 right-0 border-t border-border/20 bg-background/80 backdrop-blur-sm p-4">
          ...
          <div className="flex items-center gap-2">
            <div className="relative flex-1">
              <Input
                ...
                className="pr-12 bg-muted/30 border-border/30 focus:bg-background focus:border-teal-500/50 transition-all duration-200 w-full"
              />
              <Button
                onClick={handleSendMessage}
                disabled={newMessage.trim() === "" || isLoading}
