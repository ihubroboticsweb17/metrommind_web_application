...
interface PasswordRestBackgroundProps {
  themeClasses: string;
  children: ReactNode;
}

const PasswordRestBackground = ({ themeClasses, children }: PasswordRestBackgroundProps) => {
  return (
...
export default PasswordRestBackground;