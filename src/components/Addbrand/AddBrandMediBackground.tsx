...
interface AddBrandMediBackgroundProps {
  themeClasses: string;
  children: ReactNode;
}

const AddBrandMediBackground = ({ themeClasses, children }: AddBrandMediBackgroundProps) => {
  return (
...
export default AddBrandMediBackground;