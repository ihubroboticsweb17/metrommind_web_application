...
const RegisterBackground = ({ themeClasses, children }: RegisterBackgroundProps) => {
  return (
...
// const RegisterBackground: React.FC<RegisterBackgroundProps> = ({ themeClasses, children }) => {
//   return <div className={`register-background ${themeClasses}`}>{children}</div>;
// };
